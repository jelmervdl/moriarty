...
\abstract{
    ...
    Much research has been put into defining arguments into formal structures, resulting in both abstract formal approaches that cannot be easily linked to natural language, or semantic definitions that require broad understanding of the text and subject. It has been tried to bridge this semantic gap using machine learning. % State of the art
    ...
    we can start developing computer interpretable argumentation and let the computer understand or support humans when arguing.% Result
}
