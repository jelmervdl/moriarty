...
grammar = category.grammar | prototype.grammar | verb.grammar | {
    ...
    Rule('GENERAL_CLAIM', [RuleRef('PROTOTYPE'), Literal('has'), RuleRef('CATEGORY')],
        GeneralClaim.from_rule),
    ...
    Rule('GENERAL_CLAIM', [RuleRef('PROTOTYPES'), Literal('have'), RuleRef('CATEGORY')],
        GeneralClaim.from_rule),
    Rule('GENERAL_CLAIM', [RuleRef('PROTOTYPES'), Literal('have'), RuleRef('PROTOTYPES')],
        GeneralClaim.from_rule),
